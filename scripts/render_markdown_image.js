...
async function main() {
  ...
  const mode = process.argv.includes('--xhs') ? 'xhs' : 'default';
  const html = mode === 'xhs' ? `<!doctype html><html lang="zh-CN"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>${escapeHtml(title)}</title><style>:root{--bg:#f8f5ee;--paper:#fffdf9;--text:#222;--muted:#8a6f55;--border:#eadfce;--accent:#c9783a}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif}.page{width:1179px;min-height:1200px;margin:0 auto;padding:16px 14px 18px;display:flex;justify-content:center;align-items:flex-start}.card{width:100%;background:var(--paper);border:2px solid var(--border);border-radius:24px;box-shadow:0 10px 26px rgba(90,60,30,.06);padding:24px 28px}.meta{font-size:16px;color:var(--muted);margin-bottom:8px;font-weight:600}h1,h2,h3,h4,h5,h6{margin:.5em 0 .25em;line-height:1.22}h1{font-size:46px}h2{font-size:34px}h3{font-size:28px}h4{font-size:24px}p,li,blockquote,pre{font-size:25px;line-height:1.52}p{margin:.22em 0}ul{margin:.12em 0 .5em .85em;padding:0}li{margin:.12em 0}blockquote{margin:.45em 0;padding:12px 14px;border-left:6px solid var(--accent);background:#fff5eb;color:#5b4028;border-radius:0 12px 12px 0}code{background:#f7efe4;border:1px solid #eadfce;border-radius:6px;padding:1px 6px;font-size:.86em;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}pre{white-space:pre-wrap;word-break:break-word;background:#3b2b1f;color:#f8efe7;padding:14px 16px;border-radius:14px;overflow:hidden}pre code{background:transparent;border:0;padding:0;color:inherit}a{color:#b8662b;text-decoration:none}strong{color:#8f4d19}</style></head><body><div class="page"><div class="card"><div class="meta">AI 情报笔记</div>${body}</div></div></body></html>` : `<!doctype html><html lang="zh-CN"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>${escapeHtml(title)}</title><style>:root{--bg:#f5f7fb;--paper:#ffffff;--text:#18212f;--muted:#5f6b7a;--border:#e5e9f0;--accent:#2563eb}*{box-sizing:border-box}body{margin:0;background:linear-gradient(180deg,#eef4ff 0%,var(--bg) 100%);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Hiragino Sans GB","Microsoft YaHei",sans-serif}.page{width:1200px;margin:0 auto;padding:48px}.card{background:var(--paper);border:1px solid var(--border);border-radius:24px;box-shadow:0 18px 50px rgba(15,23,42,.08);padding:52px 60px}.meta{font-size:18px;color:var(--muted);margin-bottom:18px}h1,h2,h3,h4,h5,h6{margin:1.1em 0 .55em;line-height:1.3}h1{font-size:42px}h2{font-size:32px;border-top:1px solid var(--border);padding-top:22px}h3{font-size:26px}h4{font-size:22px}p,li,blockquote,pre{font-size:22px;line-height:1.75}p{margin:.5em 0}ul{margin:.3em 0 1em 1.2em;padding:0}li{margin:.25em 0}blockquote{margin:1em 0;padding:16px 20px;border-left:6px solid var(--accent);background:#f8fbff;color:#24364d;border-radius:0 12px 12px 0}code{background:#f1f5f9;border:1px solid #e2e8f0;border-radius:8px;padding:2px 8px;font-size:.9em;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}pre{white-space:pre-wrap;word-break:break-word;background:#0f172a;color:#e2e8f0;padding:18px 22px;border-radius:16px;overflow:hidden}pre code{background:transparent;border:0;padding:0;color:inherit}a{color:var(--accent);text-decoration:none}</style></head><body><div class="page"><div class="card"><div class="meta">Markdown 图片副本 · ${escapeHtml(title)}</div>${body}</div></div></body></html>`;
